...
![img](https://coolshell.cn/wp-content/uploads/2020/12/slice1-300x190.png)
...
- 首先先创建一个`foo`的slice，其中的长度和容量都是5；
- 然后开始对`foo`所指向的数组中的索引为3和4的元素进行赋值；
- 然后，对`foo`做切片后赋值给`bar`，再修改`bar[1]`。

![img](https://coolshell.cn/wp-content/uploads/2020/12/slice2.png)
...
![img](https://coolshell.cn/wp-content/uploads/2020/12/go.slices.append-1024x513.png)
...
![img](https://coolshell.cn/wp-content/uploads/2020/12/slice4-1024x740.png)
